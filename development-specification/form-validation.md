...
|:----:|:----:|:----:|:----:|:----:|
|用户名| 由 1到64位 的字符（除特殊字符）组成|username_yf-2016|-- |64|
...
|银行卡| 一般由 16 或 19位的数字组成，卡号规则[1]，校验列表[2] | -- |`/^[1-9](\d{15}|\d{18})$/`|19|
...
[1] 银行卡号编码规则及其应用  https://zhuanlan.zhihu.com/p/21399490  
[2] 国内各个银行的卡号规则   https://github.com/navyxie/bankcardinfo/blob/master/index.js#L40